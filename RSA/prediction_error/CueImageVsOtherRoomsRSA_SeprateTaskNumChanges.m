function [ResultsCueImSim, ResultsCueImSimItemsCount, ResultsCueImSimOnlyNum]=CueImageVsOtherRoomsRSA_SeprateTaskNumChanges(engram,remove_outliers)

% I did not remove outliers in the main analysis. I don't think it mattered
% much

warning('off','all')
if remove_outliers
    display('analysis removes outleirs');
...
results_fname=sprintf('CueImageVsOtherRoomsExcludeSameRoom_Ftrans%s.mat',out_ttl);
